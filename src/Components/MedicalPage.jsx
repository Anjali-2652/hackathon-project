  ...
  return (
    ...
    <div className='flex bg-slate-300 h-dvh '>
      <div className="m-[100px] flex flex-wrap gap-y-10 ">
        <a href="src/assets/Medical Note.pdf" className='bg-gradient-to-r bg-slate-800 text-white  rounded-2xl  text-4xl font-bold h-fit py-7 px-[100px]'>Medical Entrance Notes</a>
